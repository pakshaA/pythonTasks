...
def boolean1():
    ...
    a = read_and_check("Введите ваше число: ")
    if a > 0:
...
def boolean2():
    ...
    a = read_and_check("Введите число : ")
    if a % 2 != 0:
...
def boolean4():
    ...
    a, b = read_and_check("Введите числа А и Б через пробел: ", 2, ["Число A ", "Число B "])
    if a > 2 and b <= 3:
...
def boolean6():
    ...
    a, b, c = read_and_check("Введите числа А, Б и С через пробел: ", 3, ["Число A ", "Число B ", "Число C "])
    if a < b < c:
        print("Выражение справедливо.")
    else:
        print("Выражение несправедливо")
