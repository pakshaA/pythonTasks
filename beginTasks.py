...
def begin1():
    print("Периметр квадрата = ", read_and_check("Введите сторону квадрата: ")*4)


def begin2():
    print("Площадь квадрата = ", read_and_check("Введите сторону квадрата: ")**2)


def begin3():
    print("Площадь прямоугольника = ",
          read_and_check("Введите первую сторону: ")*read_and_check("Введите вторую сторону: "))


def begin4():
    print("Длина окружности = ", read_and_check("Введите диаметр окружности: ")*3.14)


def begin5():
    a = read_and_check("Введите длину ребра куба: ")
    print("Объем куба = ", a**3, "\n"
          "Площадь поверхности куба = ", 6*(a**2))


def begin6():
    a, b, c = read_and_check("Введите длины ребер: ", 3)
    print("Объем прямоугольного параллелепипида = ", a*b*c, "\n" 
          "Площадь его поверхности = ", 2*(a*b+b*c+a*c))


def begin7():
    r = read_and_check("Введите радиус: ")
    print("Длина окружности = ", 2*3.14*r, "\n"
          "Площадь окружности = ", 3.14*(r**2))


def begin8():
    a, b = read_and_check("Введите 2 числа: ", 2)
...
def begin12():
    a, b = read_and_check("Введите 2 катета: ", 2, ["Катет №1", "Катет №2"])
    c = (a**2+b**2)**0.5
    print("Гипотенуза = ", c, "\n",
          "Периметр = ", a+b+c)
...
def begin13():
    r1, r2 = read_and_check("Введите радиусы кругов: ", 2, ["Радиус №1", "Радиус №2"])
    s1 = 3.14*(r1**2)
    s2 = 3.14*(r2**2)
    s3 = s1 - s2
...
def begin14():
    length = read_and_check("Введите длину окружности: ")
    r = length/(2*3.14)
    s = 3.14*(r**2)
...
def begin15():
    s = read_and_check("Введите площадь круга: ")
    r = (s/3.14)**0.5
    length = 2*3.14*r
    d = 2*r
    print("Диаметр = ", d, '\n'
...
def begin16():
    x1, x2 = read_and_check("Введите координаты 2х точек: ", 2, ["Координата точки №1", "Координата точки №2"])
...
def begin22():
    a, b = (i for i in input("Введите содержание 2х переменных: ").split())
    a, b = b, a
...
def begin23():
    a, b, c = (i for i in input("Введите содержание 3х переменных: ").split())
    a, b, c = c, a, b
    print("После замены переменных местами A = ", a, '\n'
          "B = ", b, '\n'
          "C = ", c)
...
def begin25():
    x = read_and_check("Введите значение х: ")
    y = 3 * (x ** 6) - 6 * (x ** 2) - 7
    print("y = ", y)
...
def begin27():
    a = read_and_check("Введите значение А: ")
    print("A^2 = ", a**2, '\n'
          "A^4 = ", a**4, '\n'
          "A^8 = ", a**8)
